    ...
    .row.justify-content-center
      .col-md-10 
        .titulo-sexto.color-acento-contenido
          h5 Figura 2
          p.mb-0
            em Esquema de clasificación de los datos

    img.img-a.img-t.mb-5(data-aos="zoom-in")(src='@/assets/curso/temas/img15.svg', alt='')

    #t_4_2.cuadrado.mb-4(data-aos="zoom-in-left")
      h3 
        i.fas.fa-square   
